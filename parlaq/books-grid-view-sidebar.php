							...
							<div class="accordion accordion-inner" id="filter-inner">
								<div class="accordion-item">
									<button class="accordion-button" id="headingOne_inner" type="button"
										...
										aria-expanded="true" aria-controls="collapseOne_inner">Best Seller
										(105)</button>
					...
					<div class="row book-grid-row">
						...
						<div class="col-book style-2">
							<div class="dz-shop-card style-1">
								...
								<div class="dz-content dz-content--height">
									<h5 class="title title__width mb-0"><a href="books-detail.php">Babil Yanark.</a>
									</h5>
						...
						<div class="col-md-12">
							<nav aria-label="Blog Pagination">
								<ul class="pagination style-1 p-t20">
									...
									<li class="page-item"><a class="page-link next" href="javascript:void(0);">İrəli</a>
									</li>
								</ul>
							</nav>
						</div>
