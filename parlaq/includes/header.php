...
<head>
	...
	<meta name="description" content="Parlaq İmzalar"/>
	<meta property="og:title" content="Parlaq İmzalar"/>
	...
	<link rel="stylesheet" type="text/css" href="assets/icons/themify/themify-icons.css">
							...
							<li class="nav-item">
								...
								<ul class="dropdown-menu cart-list">
										...
										<div class="media"> 
											<div class="media-left"> 
												<a href="books-detail.php"> 
													<img alt="" class="media-object" src="assets/images/booksimage/blog-5.jpg"> 
												</a> 
											</div> 
											<div class="media-body"> 
												<h6 class="dz-title"><a href="books-detail.php" class="media-heading">Richard Koch – 80/20 prinsipi</a></h6>
									...
									<li class="cart-item text-center">
										<h6 class="text-secondary">Ümumi = ₼74.00</h6>
									</li>
									<li class="text-center d-flex">
										<a href="shop-cart.php" class="btn btn-sm btn-primary me-2 btnhover w-100">Səbətə bax </a>
										<a href="shop-checkout.php" class="btn btn-sm btn-outline-primary btnhover w-100">Sifariş et</a>
									</li>
								</ul>
							</li>
							<li class="nav-item dropdown profile-dropdown  ms-4">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
									...
									<div class="profile-info">
										<h6 class="title">Səfər</h6>
										<span>sefer@gmail.com</span>
									</div>
								</a>
								<div class="dropdown-menu py-0 dropdown-menu-end">
									<div class="dropdown-header">
										<h6 class="m-0">Səfər</h6>
										<span>sefer@gmail.com</span>
									</div>
									<div class="dropdown-body">
										...
										<a href="shop-cart.php" class="dropdown-item d-flex justify-content-between align-items-center ai-icon">
											<div>
												...
												<span class="ms-2">Sifarişlərim</span>
											</div>
										</a>
										<a href="wishlist.php" class="dropdown-item d-flex justify-content-between align-items-center ai-icon">
											<div>
												...
												<span class="ms-2">Seçilmişlər</span>
											</div>
										</a>
									</div>
									<div class="dropdown-footer">
										<a class="btn btn-primary w-100 btnhover btn-sm" href="shop-login.php">Çıxış</a>
									</div>
								</div>
							</li>
						</ul>
				...
				<div class="header-search-nav">
					<div class="header-item-search">
						<div class="input-group search-input">
							...
							<input type="text" class="form-control" aria-label="Text input with dropdown button" placeholder="Kitablara bax">
				...
				<div class="container clearfix">
					...
					<div class="header-nav navbar-collapse collapse justify-content-start" id="navbarNavDropdown">
						...
						<ul class="nav navbar-nav">
							<li class="sub-menu-down main__page--logo unShown"><a class="main__page--logo---style" href="index.php"><span class="main__page--box"><img src="assets/images/booksimage/parlaqWhite1.svg" alt=""></span></a>
								<!-- <ul class="sub-menu">
							...
							<li class="sub-menu-down"><a href="books-grid-view-sidebar.php"><span>Kitablar</span></a>
							<li class="sub-menu-down"><a href="books-grid-view-sidebar.php"><span>Yeni Kitablar</span></a>
								<!-- <ul class="sub-menu">
