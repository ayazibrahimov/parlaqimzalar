												...
												<div class="media-left">
													<a href="books-detail.php">
														<img alt="" class="media-object"
															src="assets/images/booksimage/blog-5.jpg">
													</a>
												</div>
												<div class="media-body">
													<h6 class="dz-title"><a href="books-detail.php"
															class="media-heading">Richard Koch – 80/20 prinsipi</a></h6>
												...
												<ul class="dropdown-menu cart-list">
													<li class="cart-item">
														<div class="media">
															...
															<div class="media-body">
																<h6 class="dz-title"><a href="books-detail.php"
																		class="media-heading">Richard Koch – 80/20
																		prinsipi</a></h6>
																<span class="dz-price">₼28.00</span>
																<span class="item-close">&times;</span>
															</div>
