						  ...
						  <div class="dz-box">
							...
							<div class="swiper bookSwiper">
                             <div class="swiper-wrapper">
                                <div class="swiper-slide"><a data-fancybox="gallery" href="assets/images/booksimage/imageTest-1.webp"><img src="assets/images/booksimage/imageTest-1.webp" alt=""></a></div>
                                <div class="swiper-slide"><a data-fancybox="gallery" href="assets/images/booksimage/imageTest-2.webp"><img src="assets/images/booksimage/imageTest-2.webp" alt=""></a></div>
                                <div class="swiper-slide"><a data-fancybox="gallery" href="assets/images/booksimage/imageTest-3.webp"><img src="assets/images/booksimage/imageTest-3.webp" alt=""></a></div>
							...
							<div class="dz-content">
								...
								<div class="dz-body">
									...
									<p class="text-1">2012, Paris. Édouard Louis arkadaşlarıyla yediği Noel yemeğinden sonra gece yarısı evine dönerken,
										 yolda tanıştığı bir adamın ısrarına dayanamayıp onu evine davet eder. Reda ona çocukluğunu ve babasının 
										 Cezayir’den kaçarak nasıl Fransa’ya geldiğini anlatır. Gecenin geri kalanını sohbet ederek, gülerek geçirirler.
										  Fakat bir süre sonra işler değişir: Reda bir anda tarifsiz bir şiddetin failine dönüşürken, Édouard’ın payına 
										  düşense seçmediği bir hikâyenin kurbanı, seçmediği bir acının taşıyıcısı olmaktırş Şiddetin Tarihi, o gece 
										  yaşananların izini sürerken, şiddetin kökenlerini, doğasını ve onu tırmandıran dinamikleri, göçmenlik, ırkçılık, 
										  eril şiddet ve travma üzerinden anlamlandırmaya çalışan bir araştırmaya girişiyor.</p>
							...
							<div class="tab-content">
								<div id="graphic-design-1" class="tab-pane show active">
                                    <table class="table border book-overview">
                                        ...
                                        <tr>
                                            <th>Kitabın formati</th>
                                            <td>Dram, 450 səhifə</td>
                                        </tr>
                                        <tr>
                                            <th>Çap ili</th>
                                            <td>10 Avqust 2019</td>
                                        </tr>
										<tr>
                                            <th>Nəşriyyatçı</th>
                                            <td>Parlaq İmzalar</td>
                                        </tr>
										<tr>
                                            <th>Səhifələr</th>
                                            <td>240</td>
							...
							<div class="row">
								<div class="col-xl-12 col-lg-6">
									<div class="dz-shop-card style-5">
										...
										<div class="dz-content">
											<a href="books-detail.php"><h5 class="subtitle">Çərpələng uçuran</h5></a>
											<ul class="dz-tags">
												<li>THRILLE,</li>
												<li>DRAMA,</li>
												<li>HORROR</li>
								...
								<div class="col-xl-12 col-lg-6">
									<div class="dz-shop-card style-5">
										<div class="dz-media">
										<a href="books-detail.php"><img src="assets/images/booksimage/min-möhtəşəm-günəş.jpg" alt=""></a>
										</div>
										<div class="dz-content">
										<a href="books-detail.php"><h5 class="subtitle">Min Möhtəşəm Günəş</h5></a>
											<ul class="dz-tags">
												<li>THRILLE,</li>
												<li>DRAMA,</li>
												<li>HORROR</li>
								...
								<div class="col-xl-12 col-lg-6">
									<div class="dz-shop-card style-5">
										<div class="dz-media">
										<a href="books-detail.php"> <img src="assets/images/booksimage/sehra-ciceyi.jpg" alt=""> </a>
										</div>
										<div class="dz-content">
										<a href="books-detail.php"><h5 class="subtitle">Səhra Çiçəyi</h5> </a>
											<ul class="dz-tags">
												<li>THRILLE,</li>
												<li>DRAMA,</li>
												<li>HORROR</li>
		...
		<!-- <div class="bg-white py-5">
			<div class="container">
				...
				<div class="swiper client-swiper">
					<div class="swiper-wrapper">
						<div class="swiper-slide"><img src="assets/images/client/client1.svg" alt="client"></div>
						<div class="swiper-slide"><img src="assets/images/client/client2.svg" alt="client"></div>
						<div class="swiper-slide"><img src="assets/images/client/client3.svg" alt="client"></div>
						<div class="swiper-slide"><img src="assets/images/client/client4.svg" alt="client"></div>
						<div class="swiper-slide"><img src="assets/images/client/client5.svg" alt="client"></div>	
					</div>
				</div>
			</div>
		</div> -->
