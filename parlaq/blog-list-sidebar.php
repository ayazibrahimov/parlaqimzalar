				...
				<div class="dz-bnr-inr-entry">
					...
					<nav aria-label="breadcrumb" class="breadcrumb-row">
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item">Xəbərlər</li>
						</ul>
					</nav>
				</div>
			</div>
					...
					<div class="col-xl-8 col-lg-8">
						<div class="dz-blog style-1 bg-white m-b30 blog-half">
							...
							<div class="dz-info">
								...
								<p class="m-b0">“I Beynәlxalq Rәsulzadә Qiraәtlәri. Mәhәmmәd Əmin Rәsulzadәnin irsi Müstәqilik, Demokratiya vә Dövlәtçilik dәyәrlәri sistemindә” kitabının tәqdimat mәrasimi keçirilib.</p>
						...
						<div class="dz-blog style-1 bg-white m-b30 blog-half">
							<div class="dz-media dz-img-effect zoom post-video">
								<a href="news-detail.php">
									<img src="assets/images/booksimage/new-6.jpg" alt="">
							...
							<div class="dz-info">
								...
								<div class="dz-meta meta-bottom">
									<ul class="border-0 pt-0">
										<li class="post-date"><i class="far fa-calendar fa-fw m-r10"></i>7 Mart, 2022</li>
										<li class="post-author"><i class="far fa-user fa-fw m-r10"></i>By <a href="javascript:void(0);"> Fuad Abdinov</a></li>
										<!-- <li class="post-comment"><a href="javascript:void(0);"><i class="far fa-comment-alt fa-fw"></i><span>15</span></a></li> -->
									</ul>
								</div>
							</div>
						...
						<div class="dz-blog style-1 post-quote bg-white m-b30 blog-half">
							<div class="dz-info">
								...
								<h4 class="dz-title">
									<a href="news-details-2.php">Kitablar ən sakit və daimi dostlardır; və müəllimlərin ən səbirlisidir.</a>
								</h4>
							</div>
						</div>
						<nav aria-label="Blog Pagination">
							<ul class="pagination text-center p-t20 style-1">
								<li class="page-item"><a class="page-link prev" href="javascript:void(0);">Geri</a></li>
						...
						<aside class="side-bar sticky-top mt-lg-0 mt-md-5">
							...
							<div class="widget widget_categories">
								...
								<ul>
									...
									<li class="cat-item cat-item-27"><a href="blog-list-sidebar.php">assets/Images</a> (1)</li>
							...
							<div class="widget recent-posts-entry">
								...
								<div class="widget-post-bx">
									<div class="widget-post clearfix">
										<div class="dz-media"> 
											<a href="news-detail.php"><img src="assets/images/booksimage/blog-5.jpg" alt=""></a>
										</div>
										<div class="dz-info">
											<h6 class="title"><a href="news-detail.php">Richard Koch – 80/20 prinsipi</a></h6>
											<div class="dz-meta">
												<ul>
