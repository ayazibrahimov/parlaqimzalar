		...
		<div class="page-content">
					...
					<div class="dz-bnr-inr-entry">
						...
						<nav aria-label="breadcrumb" class="breadcrumb-row">
							<ul class="breadcrumb">
								...
								<li class="breadcrumb-item">Əlaqə</li>
							</ul>
						</nav>
					</div>
				</div>
			...
			<div class="content-inner-2 pt-0">
				<div class="map-iframe">
					<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12152.460380479428!2d49.9429478!3d40.406301!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x403063020d7c3fe9%3A0x79aeb5755594c4af!2zUGFybGFxIMSwbXphbGFyIE7JmcWfcml5eWF0xLE!5e0!3m2!1sen!2s!4v1675151973190!5m2!1sen!2s" style="border:0; width:100%; min-height:100%; margin-bottom: -8px;" allowfullscreen ></iframe>
				</div>
			</div>
		
			<section class="contact-wraper1" style="background-image: url(assets/images/background/bg2.jpg);">	
				<div class="container">
					<div class="row">
						<div class="col-lg-5">
							<div class="contact-info">
								<div class="section-head text-white style-1">
									<h3 class="title text-white">Əlaqəyə keçin</h3>
									<p>Bizimlə işləməkdə maraqlısınızsa, zəhmət olmasa əlaqə saxlayın.</p>
								</div>
								<ul class="no-margin">
									<li class="icon-bx-wraper text-white left m-b30">
										...
										<div class="icon-content">
											<h5 class=" dz-tilte text-white">Ünvanımız</h5>
											<p>Qara Qarayev 82 A, Bakı 1096</p>
										</div>
									</li>
									<li class="icon-bx-wraper text-white left m-b30">
										<div class="icon-md">
						...
						<div class="col-lg-7 m-b40">
							<div class="contact-area1 m-r20 m-md-r0">
								<div class="section-head style-1">
									...
									<h3 class="title m-b20">Bizimlə Əlaqə Saxlayın</h3>
								</div>
								<form class="dz-form dzForm" method="POST" action="script/contact_smtp.php">
									<input type="hidden" class="form-control" name="dzToDo" value="Contact">
									<div class="dzFormMsg"></div>		
									<div class="input-group">
										<input required type="text" class="form-control" name="dzName" placeholder="Adınız">
									</div>
									<div class="input-group">
										<input required type="text" class="form-control" name="dzEmail" placeholder="Email">
									</div>
									<div class="input-group">
										<input required type="text" class="form-control" name="dzPhoneNumber" placeholder="Telefon">
									</div>
									<div class="input-group">
										<textarea required name="dzMessage" rows="5" class="form-control">Mesaj</textarea>
									</div>
									<div class="mb-3">
									...
									<div>
										<button name="submit" type="submit" value="submit" class="btn w-100 btn-primary btnhover">GÖNDƏR</button>
									</div>
								</form>
							</div>
						</div>
