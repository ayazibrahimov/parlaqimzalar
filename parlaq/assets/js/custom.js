		...
		jQuery(window).on('scroll', function () {
			if(jQuery('.sticky-header').length > 0){
				...
				if ($(window).scrollTop() > menu.offset().top) {
					...
					jQuery('.main__page--logo').removeClass('unShown')
					jQuery('.exra-nav__major').removeClass('unShown')
				} else {
					menu.removeClass('is-fixed');
					jQuery('.main__page--logo').addClass('unShown')
					jQuery('.exra-nav__major').addClass('unShown')
				}
			}
		});
...
// document.querySelector('.dzdrop-menu').classList
