...
<!-- About Author -->
<section class="content-inner  testimonial-wrapper-2">
	<div class="container">
...
<section class="content-inner-1">
	<div class="container">
		...
		<div class=" book-grid-row">
			<div class="author__all--books">
				<div class="author__all--books_data">
					<div class="style-2">
						<div class="book-grid__padd">
...
<section class="content-inner-2 bg-grey">
	<div class="container">
		<div class="section-head book-align">
			<h2 class="title mb-0">Müəlliflə Əlaqəli Bloq</h2>
			
		</div>
		<div class="row">
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="dz-blog style-1 bg-white m-b30">
					<div class="dz-media dz-img-effect author__bookdz-img-effect zoom">
						<a href="blog-detail.php"><img src="assets/images/booksimage/blog-2.png" alt=""></a>
					</div>
					<div class="dz-info">
						<h4 class="dz-title author__blog--dz-title">
						...
						<p class="m-b0">Bu kitab qeyri-adi davranış nümayiş etdirən insanlar haqqındadır. O insanlar
							ki, onların hərəkətləri və nai&shy;
							alim&shy;</p>
