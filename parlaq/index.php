    ...
    <div class="page-content bg-white">
    	...
    	<div class="bg-white py-4">
    		<div class="container">
    			...
    			<div class="swiper client-swiper">
    				<div class="swiper-wrapper">
    					<div class="swiper-slide"><img src="assets/images/booksimage/parlaqIrsad.svg" alt="client">
    					</div>
    					<div class="swiper-slide"><img src="assets/images/booksimage/parlaqMono.svg" alt="client"></div>
    					<div class="swiper-slide"><img src="assets/images/booksimage/parlaqSimurq.svg" alt="client">
    					</div>
    					<div class="swiper-slide"><img src="assets/images/booksimage/parlaqIrsad.svg" alt="client">
    					</div>
    					<div class="swiper-slide"><img src="assets/images/booksimage/parlaqMono.svg" alt="client"></div>
    	...
    	<section class="content-inner-1 bg-grey reccomend pt-5">
    						...
    						<div class="dz-blog style-1 bg-white m-b30">
    							...
    							<div class="dz-info">
    								...
    								<div class="dz-meta meta-bottom">
    									<ul class="">
    										<li class="post-date"><i class="far fa-calendar fa-fw m-r10"></i>10 Mart,
    											2022</li>
    										<li class="post-author"><i class="far fa-user fa-fw m-r10"></i>By <a
    												href="javascript:void(0);"> Ramiz Abilov</a></li>
    									</ul>
    								</div>
    							</div>
    						</div>
    					...
    					<div class="testimonial-1 wow fadeInUp" data-wow-delay="0.1s">
    						<div class="testimonial-info">
    							...
    							<div class="testimonial-text">
    								<p> Ədəbiyyat nəzəriyyəsinin elə problemləri var ki, onlar həmişə gündəmdədir,
    									ədəbiyyatın hər mərhəsində nəzəri fikirlərin təzələnməsinə ehtiyac duyulur</p>
    							</div>
    					...
    					<div class="swiper-slide">
    						<div class="dz-blog style-1 bg-white m-b30 wow fadeInUp" data-wow-delay="0.1s">
    							...
    							<div class="dz-info p-3">
    								...
    								<p class="m-b0">Əvvəllər yalnız incəsənətin hökm sürdüyü bir sahəni elmi baxımdan
    									izah edib. Hər bir sahibkar və innovasiya ilə maraqlanan hər bir menecer bu
    									kitabı mütləq oxumalıdır</p>
    								<div class="dz-meta meta-bottom mt-3 pt-3">
    									<ul class="">
    										<li class="post-date"><i class="far fa-calendar fa-fw m-r10"></i>24 Mart,
    											2022</li>
    									</ul>
    								</div>
    							</div>
    				...
    				<div
    					...
    					<div class="col-xl-7 col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
    						<div class="section-head mb-0">
    							<h2 class="title text-white my-lg-3 mt-0">Ən yeni kitab yeniləmələri üçün bülletenimizə
    								abunə olun</h2>
    						</div>
    					</div>
