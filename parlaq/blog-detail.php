				...
				<div class="dz-bnr-inr-entry">
					...
					<nav aria-label="breadcrumb" class="breadcrumb-row">
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item">Bloq məlumatı</li>
						</ul>
					</nav>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-xl-8 col-lg-8">
							...
							<div class="dz-info">
								<div class="dz-meta  border-0 py-0 mb-2">
									<ul class="border-0 pt-0">
										...
										<li class="post-author"><i class="far fa-user fa-fw m-r10"></i>By <a href="javascript:void(0);"> Ferid Abdinov</a></li>
									</ul>
								</div>
								<h4 class="dz-title">30 yaşadək oxumalı olduğumuz 30 kitab</h4>
								<div class="dz-post-text">
									<p>Sizinlə razıyam ki, deyirlər, "Bəzi kitabların yaşı yoxdur". Lakin, bir şeyi də unutmayaq ki, dünyagörüşünün və həyata baxış şəklimizin formalaşmasında mütaliə yaşımız xeyli rol oynayır. Elə kitablar var ki, yeniyetmə və gənclik çağında oxunması daha gözəl nəticələrə səbəb ola bilər. Bu baxımdan sizə dünya ədəbiyyatından otuz yaşadək mütləq oxumalı olduğumuz otuz kitabı təqdim edirik. </p>
									<blockquote class="wp-block-quote is-style-default"><p>Rahatlıqla xoşbəxtlik olmaz. Xoşbəxtlik əzabla əldə edilər, insanoğlu həyata xoşbəxt olmaq üçün gəlməmişdir. </p><cite>Fyodor Dostoyevski</cite></blockquote>
									<p>Fyodor Mixayloviç Dostoyevski (11 noyabr 1821-9fevral 1881)-rus yazıçı, dünya ədəbiyyatının
										ən böyük yazıçılarından biri. Dostoyevskinin ilk romanı Bədbəxt insanlar 1846-cı ildə nümayiş olundu. Bu əsərinin ardından yazdığı kitablarla gözlədivi müvəffəqiyyətə çata bilməyən Dostoyevskinin ümidi qırıldı və siyasətlə maraqlanmağa başladı. </p>
									<h4 class="m-b30">Qumarbaz, Fyodor Dostoyevski</h4>
									<img class="alignleft rounded-md w-25" src="assets/images/booksimage/blog-8.jpg" alt="">
									<p> Peterburqa döndükdən sonra Alçaldılmış və təhqir olunmuşlar (1861) və Ölülər evindən qeydlər (1862) adlı əsərləri yazdı. Qardaşıyla birlikdə iki jurnal çıxardı. 1862-ci ildə arzuladığı Avropa səyahətini reallaşdırdı. Xəstəliyi və qumar asılılığı ucbatından maddi baxımdan çətinliyə düşdü. </p>
									<p>Bu dövrdə Gizlindən qeydlər (1864), Cinayət və cəza (1866), Qumarbaz (1866), İdiot (1868), Əbədi ər (1870) və Cinlər (1872) kimi əsərləri yazdı. Yeniyetmə (1875), Bir yazıçının gündəliyi (1876) və Karamazov qardaşları (1880) adlı əsərlərində yazıçılıq həyatı boyunca yazdığı mövzuları yenidən ələ aldı.</p>
									<p>Karamazovqardaşları adlı əsərini iki ildə bitirən Dostoyevski, bir ciyər qanamasıyla yatağa düşdü və 28 yanvar 1881-ci ildə vəfat etdi.</p>
								</div>
						...
						<div class="row extra-blog style-1">
							<div class="col-lg-12">
								<h4 class="blog-title">OXŞAR BLOQLAR</h4>
							</div>
							<div class="col-lg-6 col-md-6">
								<div class="dz-blog style-1 bg-white m-b30">
									<div class="dz-media">
										<a href="blog-detail.php"><img src="assets/images/booksimage/new-book.jpg" alt=""></a>
									</div>
									<div class="dz-info">
										<h5 class="dz-title">
											<a href="blog-detail.php">Parlaq İmzlar Nəşrlər Evində üç yeni kitab satışa göndərilib. </a>
										</h5>
										<p class="m-b0"> Satışa çıxarılan kitablar Etel Lilian Voyniçin "Cek Reymond”, Harvey Mackayin "Real dünyada satış üzrə MBA kursu” və Ahmet Batmanın "Səhər yuxum”adlı əsərlərdir. </p>
						 ...
						 <div class="clear" id="comment-list">
							<div class="post-comments comments-area style-1 clearfix">
								...
								<div id="comment">
									...
									<li class="comment odd alt thread-even depth-1 comment" id="comment-5">
									   <div class="comment-body" id="div-comment-5">
										  <div class="comment-author vcard">
											 <img src="assets/images/profile1.jpg" alt="" class="avatar"/>
							  ...
							  <div class="default-form comment-respond style-1" id="respond">
								 <h4 class="comment-reply-title" id="reply-title">RƏY YAZ <small> <a rel="nofollow" id="cancel-comment-reply-link" href="javascript:void(0)" style="display:none;">Cancel reply</a> </small></h4>
								 <div class="clearfix">
									<form method="post" id="comments_form" class="comment-form" novalidate>
									   ...
									   <p class="col-md-12 col-sm-12 col-xs-12 form-submit">
										  ...
										  Göndər <i class="fa fa-angle-right m-l10"></i>
										  </button>
									   </p>
									</form>
								 </div>
								...
								<div class="search-bx">
									<form role="search" method="post">
										<div class="input-group">
											<input name="text" class="form-control" placeholder="Axtar" type="text">
							...
							<div class="widget recent-posts-entry">
								...
								<div class="widget-post-bx">
									<div class="widget-post clearfix">
										<div class="dz-media"> 
											<a href="blog-detail.php"><img src="assets/images/booksimage/new-book-2.jpg" alt=""></a>
										</div>
										<div class="dz-info">
											<h6 class="title"><a href="blog-detail.php">"Gəncliyin sözü" kitabı nəşr olundu.</a></h6>
											<div class="dz-meta">
												<ul>
													<li class="post-date"> 7 Mart, 2022 </li>
												</ul>
											</div>
										</div>
									</div>
