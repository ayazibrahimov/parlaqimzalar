					...
					<div class="dz-bnr-inr-entry">
						...
						<nav aria-label="breadcrumb" class="breadcrumb-row">
							<ul class="breadcrumb">
								...
								<li class="breadcrumb-item">GİZLİLİK</li>
							</ul>
						</nav>
					</div>
				</div>
						...
						<div class="col-lg-4 col-md-5 col-sm-12 m-b30 mt-md-0 mt-4">
							<aside class="side-bar sticky-top right">
								...
								<ul class="menu">
										...
										<li class="menu-item active"><a href="privacy-policy.php">Gizlilik siyasəti</a></li>
										<li class="menu-item"><a href="help-desk.php">Nəşriyyatımız</a></li>
